...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BaSHCdtL.mjs");
...
var manifest = { "8ff390233cb7d72622c8bcd363be28a7208eb0334cb600d39980c7c8012c365e": {
	functionName: "draftPleading_createServerFn_handler",
	importer: () => import("./draft-DruFTA8v.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Ca7XTn_C.mjs").then((n) => n.t),
